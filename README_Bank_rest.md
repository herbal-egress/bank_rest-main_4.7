...
**Копирование репозитория**
   - Скачайте архив проекта https://github.com/herbal-egress/bank_rest-main_4.5/archive/refs/heads/master.zip и распакуйте в папку c:\bank_rest-main_4.5
   - Перейдите в папку проекта:
      ```bash
      cd c:\bank_rest-main_4.5
      ```
...
4. **Сборка и запуск приложения**
   ...
   chcp 65001
   ```
   - Скомпилируйте проект с инициализацией тестирования: `mvn test`
   - Убедитесь, что все тесты прошли успешно и запустите приложение: `mvn spring-boot:run`
...
5. **Проверка работы программы в SwaggerUI**
   ...
   - Остановите приложение: `mvn spring-boot:stop`.
